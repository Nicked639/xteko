...
*/
var version = 1.51
$app.theme=$device.isDarkMode?"auto":"light"
        ...
        template: [{
          ...
          },
          {
            ...
            props: {
              ...
              bgcolor: $device.isDarkMode?$color("black"):$color("white"),
              font: $font(10)
            },
            layout(make, view) {         
              make.bottom.inset(0)
  ...
  views: [
    {
      ...
      props: {
        ...
        bgcolor: $device.isDarkMode?$color("#111111"):$color("#eeeeee"),
        placeholder: "Search"
      },
    ...
    views: [
      {
        ...
        props: {
          ...
          bgcolor: $device.isDarkMode?$color("#111111"):$color("tint"),
        },
        layout: function(make, view) {
